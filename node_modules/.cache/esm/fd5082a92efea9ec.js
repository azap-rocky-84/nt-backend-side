let uploadPicture,NationalTeams,fileRemover;_2ef‍.x([["createNt",()=>createNt],["updateNt",()=>updateNt],["deleteNt",()=>deleteNt],["getNt",()=>getNt],["getAllNt",()=>getAllNt]]);_2ef‍.w("../middleware/uploadPictureMiddleware",[["uploadPicture",["uploadPicture"],function(v){uploadPicture=v}]]);_2ef‍.w("../models/NationalTeams",[["default",["NationalTeams"],function(v){NationalTeams=v}]]);_2ef‍.w("../utils/fileRemover",[["fileRemover",["fileRemover"],function(v){fileRemover=v}]]);
...
const updateNt = async (req, res, next) => {
    try {
        ...
        const handleUpdateNtData = async (data) => {
            const {title, body, confederation, fifaCode, nickname, ct, mostCappedPlayer, caps, topScorer, goals} = JSON.parse(data);
            ...
            const updatedNt = await nt.save();
            return res.json(updatedNt);
        };
